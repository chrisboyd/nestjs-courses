...
const event_entity_1 = require("../events/entites/event.entity");
const coffees_config_1 = require("./config/coffees.config");
let CoffeesService = class CoffeesService {
    constructor(coffeeRepository, flavorRepository, connection, coffeesConfiguration) {
...
CoffeesService = __decorate([
    ...
    __param(3, (0, common_1.Inject)(coffees_config_1.default.KEY)),
    __metadata("design:paramtypes", [typeorm_2.Repository,
        typeorm_2.Repository,
        typeorm_2.Connection, void 0])
], CoffeesService);
